...
/** Tree */
  final public TreeNode Tree() throws ParseException {Category category;
  String terminal = "";
...
SubstNode substnode = new SubstNode(word.toString(),category,feature);
        {if ("" != null) return substnode;}
    } else if (jj_2_6(5)) {
      // FootNode (e.g. S*)
         category = Cat();
      jj_consume_token(5);
FootNode footnode = new FootNode(category);
        {if ("" != null) return footnode;}
    } else if (jj_2_7(5)) {
      jj_consume_token(6);
      category = Cat();
      jj_consume_token(5);
...
TerminalNode node = new TerminalNode(terminal, category);
  ...
  final public String Terminal() throws ParseException {Token word;
...
if (terminal != null) {if ("" != null) return word.toString() + " " + terminal;}
       {if ("" != null) return word.toString();}
    throw new Error("Missing return statement in function");
  }

  final public List<TreeNode> TreeList() throws ParseException {List<TreeNode> treelist = null;
   TreeNode tree;
    tree = Tree();
    if (jj_2_12(5)) {
      treelist = TreeList();
...
if (treelist == null)
        ...
        treelist.add(0,tree);
        {if ("" != null) return treelist;}
    throw new Error("Missing return statement in function");
  }

  final public Category Cat() throws ParseException {Token cat;
    cat = jj_consume_token(CATEGORY);
if (cat.toString().equals("DP")) {if ("" != null) return Category.DP;}
      if (cat.toString().equals("NP")) {if ("" != null) return Category.NP;}
      if (cat.toString().equals("N")) {if ("" != null) return Category.N;}
      if (cat.toString().equals("S")) {if ("" != null) return Category.S;}
      if (cat.toString().equals("V")) {if ("" != null) return Category.V;}
      if (cat.toString().equals("P")) {if ("" != null) return Category.P;}
      if (cat.toString().equals("VP")) {if ("" != null) return Category.VP;}
      if (cat.toString().equals("PP")) {if ("" != null) return Category.PP;}
      if (cat.toString().equals("DET")) {if ("" != null) return Category.DET;}
      if (cat.toString().equals("WH")) {if ("" != null) return Category.WH;}
      if (cat.toString().equals("ADV")) {if ("" != null) return Category.ADV;}
      if (cat.toString().equals("ADJ")) {if ("" != null) return Category.ADJ;}
      if (cat.toString().equals("ADJCOMP")) {if ("" != null) return Category.ADJCOMP;}
      if (cat.toString().equals("PART")) {if ("" != null) return Category.PART;}
      if (cat.toString().equals("PUNCT")) {if ("" != null) return Category.PUNCT;}
      if (cat.toString().equals("CC")) {if ("" != null) return Category.CC;}
      if (cat.toString().equals("EX")) {if ("" != null) return Category.EX;}
      if (cat.toString().equals("NUM")) {if ("" != null) return Category.NUM;}
      if (cat.toString().equals("C")) {if ("" != null) return Category.C;}
      if (cat.toString().equals("NEG")) {if ("" != null) return Category.NEG;}
    throw new Error("Missing return statement in function");
  }

  final public Feature Feat() throws ParseException {Token raw;
    raw = jj_consume_token(WORD);
{if ("" != null) return Feature.construct(raw.toString());}
    throw new Error("Missing return statement in function");
  }
