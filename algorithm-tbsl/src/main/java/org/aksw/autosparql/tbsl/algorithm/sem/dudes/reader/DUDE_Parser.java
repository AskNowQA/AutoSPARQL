...
/** DUDE */
  final public Dude DUDE() throws ParseException {Token referent;
  Token label;
  Type type;
...
Dude dude = new Dude();
  ...
  final public DominanceConstraint DominanceConstraint() throws ParseException {Label label1;
   Label label2;
   Token domType;
...
dc = new DominanceConstraint(label1,label2);
  ...
  final public Label Label() throws ParseException {Token label;
    if (jj_2_8(2)) {
      label = jj_consume_token(LABEL);
{if ("" != null) return new Label(label.toString());}
    } else if (jj_2_9(2)) {
      jj_consume_token(7);
      label = jj_consume_token(LABEL);
      jj_consume_token(8);
{if ("" != null) return new Label(label.toString(),Position.res);}
    } else if (jj_2_10(2)) {
      jj_consume_token(9);
      label = jj_consume_token(LABEL);
      jj_consume_token(8);
{if ("" != null) return new Label(label.toString(),Position.scope);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public List<DominanceConstraint> DC_List() throws ParseException {List<DominanceConstraint> dc_list = null;
DominanceConstraint dc = null;
...
if (dc_list == null)
       {
        ...
        dc_list.add(0,dc);
        {if ("" != null) return dc_list;}
    throw new Error("Missing return statement in function");
  }

  final public List<DRS> DRS_List() throws ParseException {DRS drs;
  List<DRS> drs_list = null;
    drs = DRS();
    if (jj_2_12(2)) {
      jj_consume_token(2);
...
if (drs_list == null)
       {
        ...
        drs_list.add(0,drs);
        {if ("" != null) return drs_list;}
    throw new Error("Missing return statement in function");
  }

  final public List<Argument> Arg_List() throws ParseException {Argument argument;
  List<Argument> arg_list = null;
    argument = Argument();
    if (jj_2_13(2)) {
      jj_consume_token(2);
...
if (arg_list == null)
       {
        ...
        {if ("" != null) return arg_list;}
    throw new Error("Missing return statement in function");
  }

  final public Argument Argument() throws ParseException {Token label;
  Token word;
  Token referent;
  Type type;
    jj_consume_token(10);
...
Argument argument = new Argument();
  ...
  final public Type Type() throws ParseException {Type argument;
  Type result;
  Token word;
    if (jj_2_14(2)) {
      jj_consume_token(1);
...
/** DRS */
  final public DRS DRS() throws ParseException {Set<DiscourseReferent> dr_set = null;
...
/** DR_Set*/
  final public Set<DiscourseReferent> DR_Set() throws ParseException {Token dr;
...
if (dr_set == null)
      ...
      {if ("" != null) return dr_set;}
    throw new Error("Missing return statement in function");
  }

  final public Set<DRS_Condition> Condition_List() throws ParseException {DRS_Condition condition= null;
    Set<DRS_Condition> conditions = null;
    condition = Condition();
    if (jj_2_19(2)) {
      jj_consume_token(2);
...
if (conditions == null)
  ...
  final public DRS_Condition Condition() throws ParseException {List<DiscourseReferent> dr_list;
      Token dr1;
      Token dr2;
      Token dr = null;
      Token predicate;
...
/** DR_List*/
  final public List<DiscourseReferent> DR_List() throws ParseException {Token dr;
...
if (dr_list == null)
      ...
      {if ("" != null) return dr_list;}
    throw new Error("Missing return statement in function");
  }

  final public List<Slot> Slot_List() throws ParseException {Slot slot;
  List<Slot> slots = null;
    slot = Slot();
    if (jj_2_36(2)) {
      jj_consume_token(2);
...
if (slots == null)
  ...
  final public Slot Slot() throws ParseException {Token ref;
  Token type;
...
if (words == null)
     ...
     {if ("" != null) return new Slot(ref.toString(),slottype,words);}
    throw new Error("Missing return statement in function");
  }

  final public List<String> Word_List() throws ParseException {Token word;
  List<String> words = null;
    word = word();
    if (jj_2_38(2)) {
      jj_consume_token(15);
...
if (words == null)
       {
        ...
        {if ("" != null) return words;}
    throw new Error("Missing return statement in function");
  }

  final public Token dr() throws ParseException {Token t;
    if (jj_2_39(2)) {
...
{if ("" != null) return t;}
  ...
  final public Token word() throws ParseException {Token t;
    if (jj_2_41(2)) {
      t = jj_consume_token(A);
    } else if (jj_2_42(2)) {
