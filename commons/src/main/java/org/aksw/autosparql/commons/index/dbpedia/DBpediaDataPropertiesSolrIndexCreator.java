package org.aksw.autosparql.commons.index.dbpedia;
...
public class DBpediaDataPropertiesSolrIndexCreator {
	...
	public DBpediaDataPropertiesSolrIndexCreator(String solrIndexServerURL, String coreName){
	...
	public static void main(String[] args) {
		if(args.length != 4){
			System.out.println("Usage: DBpediaDataPropertiesSolrIndexCreator <SOLR-Server-URL> <SOLR-Core-Name> <DBpedia-Version-Number> <Language-Tag> ");
			System.exit(0);
		}
		...
		new DBpediaDataPropertiesSolrIndexCreator(solrServerURL, solrCoreName).createIndex(versionNumber, languageTag);
	}
