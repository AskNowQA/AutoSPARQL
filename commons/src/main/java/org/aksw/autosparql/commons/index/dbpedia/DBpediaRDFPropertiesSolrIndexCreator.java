...
public class DBpediaRDFPropertiesSolrIndexCreator {
	...
	public DBpediaRDFPropertiesSolrIndexCreator(String solrIndexServerURL, String coreName){
	...
	public static void main(String[] args) {
		if(args.length != 4){
			System.out.println("Usage: DBpediaRDFPropertiesSolrIndexCreator <SOLR-Server-URL> <SOLR-Core-Name> <DBpedia-Version-Number> <Language-Tag> ");
			System.exit(0);
		}
		...
		new DBpediaRDFPropertiesSolrIndexCreator(solrServerURL, solrCoreName).createIndex(versionNumber, languageTag);
	}
